...
from models.vit_lora_norm import VisionTransformer, PatchEmbed, Block,resolve_pretrained_cfg, build_model_with_cfg, checkpoint_filter_fn
from models.zoo import CodaPrompt

class ViT_lora_norm(VisionTransformer):
    def __init__(
        ...
        super().__init__(img_size=img_size, patch_size=patch_size, in_chans=in_chans, num_classes=num_classes, global_pool=global_pool,
            ...
            embed_layer=embed_layer, norm_layer=norm_layer, act_layer=act_layer, block_fn=block_fn, n_tasks=n_tasks)
...
def _create_vision_transformer(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        ViT_lora_norm, variant, pretrained,
...
class SiNet(nn.Module):
    ...
    def forward(self, image, get_feat=False, get_cur_feat=False):
        logits = []
