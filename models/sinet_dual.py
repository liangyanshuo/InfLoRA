...
class SiNet(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.prompt_pool = DualPrompt(args["embd_dim"], args["total_sessions"], args["prompt_param"])
    ...
    def interface(self, image, feature):
        image_features, _ = self.image_encoder(image, q=feature, prompt=self.prompt_pool, train=False)
        image_features = image_features[:,0,:]
        image_features = image_features.view(image_features.size(0),-1)
